    ...
    public static ItemStack getHead(OfflinePlayer player) {
        ...
        loadSkin: if (cached.containsKey(player.getName())) {
            ...
            try {
                ...
                Utils.sendMessage(Utils.getConsole(), true, e.getMessage());
                Utils.sendMessage(Utils.getConsole(), true, "ERROR: Loading Url from "+player.getName());
            }
        }
    ...
    public static ItemStack getHead(UUID uuid) {
        ...
        loadSkin: if (cached.containsKey(player.getName())) {
            ...
            try {
                ...
                Utils.sendMessage(Utils.getConsole(), true, e.getMessage());
                Utils.sendMessage(Utils.getConsole(), true, "ERROR: Loading Url from UUID: "+uuid);
            }
        }
        ItemStack head = new ItemStack(XMaterial.PLAYER_HEAD.parseMaterial(), 1, (short)3);
        if (skinURL == null){

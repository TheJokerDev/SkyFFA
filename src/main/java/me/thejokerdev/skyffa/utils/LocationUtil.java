...
public class LocationUtil {
    ...
    public static String getString(Location var0, boolean var1) {
        if (var0 == null) {
            Utils.sendMessage(Utils.getConsole(), true, "&cERROR: &7Location null, can't be converted to string");
            return null;
        } else {
    ...
    public static Location getLocation(String var0) {
        ...
        Location var2 = null;
        if (var1.length < 4) {
            Utils.sendMessage(Utils.getConsole(), true, "&cERROR: Location can't be obtained from (world,x,y,z needed)'" + var0 + "'");
            ...
            try {
                ...
                Utils.sendMessage(Utils.getConsole(), true, "&cERROR: Location can't be obtained from '" + var0 + "'");
            }
        }
